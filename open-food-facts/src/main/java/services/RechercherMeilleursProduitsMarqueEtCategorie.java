...
public class RechercherMeilleursProduitsMarqueEtCategorie extends MenuService {
	...
	public void traiter(Stock stockProduits, Scanner scanner) {
		...
		for(Produit unProduit : stockProduits.getTousLesProduits()) {
			if(unProduit.getCategorie().getLibelle().equals(nomCategorie) && unProduit.getMarque().getLibelle().equals(nomMarque)) {
